...
void setup() {
    ...
    display.setRotation(2);  // Rotate 180 degrees //nakabaligtad ung OLED
...
void handleWiFiClient() {
    ...
    if (request.indexOf("/space1/forward") != -1) {
        ...
        space1.status = "occupied";
        space1.locked = true;
        space1.sendStatus();
        Serial.println("WiFi: Space 1 Forward - Status set to occupied");
        updateDisplay("Space 1 Occupied");
        ...
        space1.status = "available";
        space1.locked = false;
        space1.associatedUID = "";
        space1.sendStatus();
        Serial.println("WiFi: Space 1 Reverse - Status set to available");
        updateDisplay("Space 1 Available");
    ...
    if (request.indexOf("/space2/forward") != -1) {
        ...
        space2.status = "occupied";
        space2.locked = true;
        space2.sendStatus();
        Serial.println("WiFi: Space 2 Forward - Status set to occupied");
        updateDisplay("Space 2 Occupied");
        ...
        space2.status = "available";
        space2.locked = false;
        space2.associatedUID = "";
        space2.sendStatus();
        Serial.println("WiFi: Space 2 Reverse - Status set to available");
        updateDisplay("Space 2 Available");
