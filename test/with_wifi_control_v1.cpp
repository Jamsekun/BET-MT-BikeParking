...
// WiFi credentials
const char* ssid = "OPPO_A78"; // Replace with your WiFi SSID
const char* password = "s7dg6zmy"; // Replace with your WiFi password

// Static IP configuration
IPAddress local_IP(192, 168, 1, 100); // Replace with desired static IP
IPAddress gateway(192, 168, 1, 1);    // Replace with your router's gateway IP
    ...
    if (Serial.available()) {
        ...
        if (command.startsWith("RUN ")) {
            ...
            if (actuator == "SPACE1_FORWARD") {
                ...
                digitalWrite(SPACE1_A_LA_REVERSE, LOW);
                digitalWrite(SPACE1_B_LA_REVERSE, LOW);
                Serial.println("Override: SPACE1_FORWARD ON");
                ...
                digitalWrite(SPACE1_A_LA_FORWARD, LOW);
                digitalWrite(SPACE1_B_LA_FORWARD, LOW);
                Serial.println("Override: SPACE1_REVERSE ON");
            } else if (actuator == "SPACE1_OFF") {
                space1.stopActuators();
                Serial.println("Override: SPACE1_OFF");
                ...
                digitalWrite(SPACE2_A_LA_REVERSE, LOW);
                digitalWrite(SPACE2_B_LA_REVERSE, LOW);
                Serial.println("Override: SPACE2_FORWARD ON");
                ...
                digitalWrite(SPACE2_A_LA_FORWARD, LOW);
                digitalWrite(SPACE2_B_LA_FORWARD, LOW);
                Serial.println("Override: SPACE2_REVERSE ON");
            } else if (actuator == "SPACE2_OFF") {
                space2.stopActuators();
                Serial.println("Override: SPACE2_OFF");
            } else {
