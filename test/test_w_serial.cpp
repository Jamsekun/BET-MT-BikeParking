...
// RFID UIDs
const String UID_SPACE1 = "3CA0FFE2";
const String UID_SPACE2 = "AA2B0C7D";
...
public:
    ...
    void startLocking() {
        ...
        Serial.print("Space ");
        Serial.print(spaceNumber);
        Serial.println(" starting locking");
    ...
    void startUnlocking() {
        ...
        Serial.print("Space ");
        Serial.print(spaceNumber);
        Serial.println(" starting unlocking");
...
ParkingSpace space1(1, 1, 2, 39, 38);  // Space 1: IR on 1,2; Actuators on 39,38
ParkingSpace space2(2, 42, 41, 37, 36);  // Space 2: IR on 42,41; Actuators on 37,36
